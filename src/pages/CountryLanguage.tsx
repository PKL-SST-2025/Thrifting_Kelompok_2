      ...
      <div class="space-y-8">
        ...
        <div class="bg-gray-50 rounded-lg p-6">
          ...
          <div class="relative">
            <select
              ...
              class="w-full p-4 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 appearance-none bg-white text-gray-900"
            >
        ...
        <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div class="flex items-start">
            ...
            <div>
              <h4 class="text-sm font-medium text-purple-800">Important Note</h4>
